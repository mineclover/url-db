...
func TestToolRegistry_CallTool_GetNode(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "get_node", arguments)
...
func TestToolRegistry_CallTool_UpdateNode(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "update_node", arguments)
...
func TestToolRegistry_CallTool_DeleteNode(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "delete_node", arguments)
...
func TestToolRegistry_CallTool_FindNodeByURL(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "find_node_by_url", arguments)
...
func TestToolRegistry_CallTool_GetNodeAttributes(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "get_node_attributes", arguments)
...
func TestToolRegistry_CallTool_SetNodeAttributes(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "set_node_attributes", arguments)
...
func TestToolRegistry_CallTool_GetServerInfo(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "get_server_info", map[string]interface{}{})
