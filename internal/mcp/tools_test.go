...
func (m *MockMCPService) FilterNodesByAttributes(ctx context.Context, domainName string, filters []interface{}, page, size int) (*models.MCPNodeListResponse, error) {
	args := m.Called(ctx, domainName, filters, page, size)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*models.MCPNodeListResponse), args.Error(1)
...
func TestToolRegistry_GetTools(t *testing.T) {
	...
	expectedTools := []string{
		...
		"get_domain_attribute", "update_domain_attribute",
		"delete_domain_attribute", "get_node_with_attributes",
...
func TestToolRegistry_CallTool_ListDomains(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "list_domains", map[string]interface{}{})
...
func TestToolRegistry_CallTool_CreateDomain(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "create_domain", arguments)
...
func TestToolRegistry_CallTool_ListDomainAttributes(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "list_domain_attributes", arguments)
...
func TestToolRegistry_CallTool_CreateDomainAttribute(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "create_domain_attribute", arguments)
...
func TestToolRegistry_CallTool_GetDomainAttribute(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "get_domain_attribute", arguments)
...
func TestToolRegistry_CallTool_UpdateDomainAttribute(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "update_domain_attribute", arguments)
...
func TestToolRegistry_CallTool_DeleteDomainAttribute(t *testing.T) {
	...
	result, err := registry.CallTool(context.Background(), "delete_domain_attribute", arguments)
